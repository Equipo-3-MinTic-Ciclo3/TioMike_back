...
class Cliente(models.Model):
    ...
    idTipoIdentificacion = models.ForeignKey(TipoIdentificacion, related_name='tipo_identificacion', on_delete=models.CASCADE)
    ...
    idCiudad = models.ForeignKey(Ciudad, related_name='ciudad', on_delete=models.CASCADE)
    edad = models.IntegerField(default=0)
    telefono = models.IntegerField(default=0)
    email = models.EmailField('correo', max_length = 30)
    direccion = models.CharField('direccion', max_length = 30)
    idBarrio = models.ForeignKey(Barrio, related_name='barrio', on_delete=models.CASCADE)
